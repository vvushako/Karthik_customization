 ...
 *  
 */
package com.so.facades.flow.impl;
...
public class SessionOverrideCheckoutFlowFacade extends DefaultCheckoutFlowFacade
{
	...
	public CheckoutFlowEnum getCheckoutFlow()
	{
		...
		if (uiExperienceLevel.equals(UiExperienceLevel.MOBILE))
		{
			return CheckoutFlowEnum.MULTISTEP;
		}
		...
		if (getCurrentUserForCheckout().getType() != null)
		{
			...
			{
				LOG.info("Guest user, resetting CheckoutFlow to [" + CheckoutFlowEnum.SINGLE + "]");
				sessionOverride = CheckoutFlowEnum.SINGLE;
			}
		}
